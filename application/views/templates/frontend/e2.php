...
<body width="100%" bgcolor="#222222" style="margin: 0; mso-line-height-rule: exactly;" id="contact-form">
                            ...
                            <tr>
                                <td style="padding: 40px; padding-bottom: 15px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                    ...
                                    <dl>
                                        ...
                                        <dt>Isi pesan</dt>
                                        <dd>Saya akui bahwa saya lah yang mengambil sebanyak 55% dari dana pengadaan e-KTP di Indonesia. Uangnya ada saya simpan di bawah keset kamar tidur kucing Persia tetangga sebelah kiri saya. Mohon agar segera diproses tanpa pandang bulu kucing tersebut.</dd>
                                    </dl>
                                </td>
                            </tr>
                            <tr>
