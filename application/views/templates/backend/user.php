              ...
              if(!empty($listuseradmin)){
                foreach ($listuseradmin  as $key => $admin) {
                  ...
                  <tr>
                    ...
                    $url1 = 'hooplaadmin/'.$controller.'/actiondelete_user/'.urlencode($id);
                    $url2 = 'hooplaadmin/'.$controller.'/index_user_admin/'.urlencode($id);
                    ?>
                    ...
                    <td>
                      ...
                      (<?php echo $val->namaMENU;?>) - <a href="#" onclick="UIkit.modal.confirm('Are you sure want to delete this data?', function(){ document.location.href='<?php echo base_url().'hooplaadmin/'.$controller."/delete_join_menu_user_admin/".urlencode(encode($val->idMENUSJOINADMIN)); ?>'; });">
