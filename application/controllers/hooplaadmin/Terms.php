...
class Terms extends Admin_Controller {
	...
	public function saveterms() {
		...
		if ($this->form_validation->run() == TRUE) {
				$data = $this->Terms_m->array_from_post(array('title1TERMS','title2TERMS','title3TERMS','title4TERMS','desc1TERMS','desc2TERMS','desc3TERMS','desc4TERMS','harga1TERMS','harga2TERMS','harga3TERMS','harga4TERMS','place1TERMS','place2TERMS','place3TERMS','place4TERMS','deschargaplaceTERMS'));
